...
sys.path.insert(0, os.path.abspath("../semantic_kernel"))
...
man_pages = [(master_doc, "semantic-kernel", "semantic-kernel Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "semantic-kernel",
        "Only used for generating YAML files.",
        "Miscellaneous",
    ),
]
...
# Read both the class’ and the __init__ method’s docstring
autoclass_content = "both"
autodoc_inherit_docstrings = False

# Enable numpy style docstring preprocess
