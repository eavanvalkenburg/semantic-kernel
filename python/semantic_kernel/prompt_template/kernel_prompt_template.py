...
class KernelPromptTemplate(PromptTemplateBase):
    ...
    async def render(self, kernel: "Kernel", arguments: "KernelArguments | None" = None) -> str:
        ...
        Args:
            kernel: The kernel to use for functions.
            arguments: The arguments to use for rendering. (Default value = None)
    ...
    async def render_blocks(
        ...
        Args:
            blocks: Template blocks generated by ExtractBlocks
            kernel: The kernel to use for functions
            arguments: The arguments to use for rendering (Default value = None)
