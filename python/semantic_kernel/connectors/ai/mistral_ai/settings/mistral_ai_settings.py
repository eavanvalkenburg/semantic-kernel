...
class MistralAISettings(KernelBaseSettings):
    ...
    Args:
        api_key: MISTRAL API key, see https://console.mistral.ai/api-keys
            (Env var MISTRALAI_API_KEY)
        chat_model_id: The The Mistral AI chat model ID to use see https://docs.mistral.ai/getting-started/models/.
            (Env var MISTRALAI_CHAT_MODEL_ID)
        embedding_model_id: The The Mistral AI embedding model ID to use see https://docs.mistral.ai/getting-started/models/.
