...
class GoogleAISettings(KernelBaseSettings):
    ...
    Args:
        gemini_model_id: The Gemini model ID for the Google AI service, i.e. gemini-1.5-pro
            This value can be found in the Google AI service deployment.
            (Env var GOOGLE_AI_GEMINI_MODEL_ID)
        embedding_model_id: The embedding model ID for the Google AI service, i.e. text-embedding-004
            This value can be found in the Google AI service deployment.
            (Env var GOOGLE_AI_EMBEDDING_MODEL_ID)
        api_key: The API key for the Google AI service deployment.
            This value can be found in the Google AI service deployment.
